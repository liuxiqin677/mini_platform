...
import { CollectionProgressItem, getCollectionProgress } from '../../../../services/collection'
import { getUserProgress, UserProgressResponse } from '../../../../services/user'
...
export default function Books() {
  ...
  const handleCategoryClick = (categoryId: string) => {
    Taro.navigateTo({
      url: `/book/list/index?categoryId=${categoryId}`
    })
  }
